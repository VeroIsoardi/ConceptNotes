...
lastUser= User.create(username: "Fox", email: "fox@mail.com", password: 'blabla', password_confirmation: 'blabla')
30.upto(rand(30..50)) do |l|
  lastBook = lastUser.books.create title:"Book #{l}"
  50.upto(rand(50..100)) do |m|
